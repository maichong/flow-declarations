...
declare module execa {
  ...
  declare type StdIOOption = 'pipe' | 'ipc' | 'ignore' | 'inherit' | Stream | number | null | void;
  ...
  declare interface Options extends CommonOptions {
    /**
  ...
  declare interface SyncOptions extends CommonOptions {
    /**
     * Write some input to the `stdin` of your binary.
  ...
  declare interface ExecaReturns {
    /**
  ...
  declare type ExecaError = Error & ExecaReturns;

  declare type ExecaChildProcess = ChildProcess & Promise<ExecaReturns>;
  declare module.exports: ExecaStatic;
}
