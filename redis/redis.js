...
declare module redis {
  ...
  declare interface RetryStrategyOptions {
    error: ErrnoError;
  ...
  declare type RetryStrategy = (options: RetryStrategyOptions) => number | Error;

  declare interface ClientOpts {
    host?: string;
    port?: number;
    path?: string;
    url?: string;
  ...
  declare interface OverloadedCommand<T, U, R> {
  ...
  declare interface OverloadedKeyCommand<T, U, R> {
  ...
  declare interface OverloadedListCommand<T, U, R> {
    (arg1: T, arg2: T, arg3: T, arg4: T, arg5: T, arg6: T, cb?: Callback<U>): R;
  ...
  declare interface OverloadedSetCommand<T, U, R> {
    (key: string, arg1: T, arg2: T, arg3: T, arg4: T, arg5: T, arg6: T, cb?: Callback<U>): R;
  ...
  declare interface OverloadedLastCommand<T1, T2, U, R> {
  ...
  declare interface Commands<R> {
     ...
     */
    cluster: OverloadedCommand<string, any, R>;
    CLUSTER: OverloadedCommand<string, any, R>;
     ...
     */
    echo(message: string, cb?: Callback<string>): R;
  ...
  declare interface RedisClient extends Commands<boolean>, events$EventEmitter {
    connected: boolean;
  ...
  declare interface Multi extends Commands<Multi> {
  ...
  declare function createClient(port: number, host?: string, options?: ClientOpts): RedisClient;

  declare function createClient(unix_socket: string, options?: ClientOpts): RedisClient;

  declare function createClient(redis_url: string, options?: ClientOpts): RedisClient;

  declare function createClient(options?: ClientOpts): RedisClient;

  declare function print(err: Error | void, reply: any): void;
}
