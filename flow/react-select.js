declare module 'react-select' {
  ...
  declare type Props = {
    ...
    */
    ...
    clearAllText?: React$Node, // title for the "clear" control when multi: true
    clearRenderer?: () => React$Element<*>, // create clearable x element
    clearValueText?: React$Node, // title for the "clear" control
    ...
    filterOptions?: | boolean // eslint-disable-line
    ...
    noResultsText?: React$Node, // placeholder displayed when there are no matching search results
    ...
    placeholder?: React$Node, // field placeholder, displayed when there's no value
